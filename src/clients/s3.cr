...
module AWSSdk::AmazonS3
  ...
  @[Protocol::Field(location: :uri, name: "Bucket", required: true)]
  property bucket : String
  # <p>Key of the object for which the multipart upload was initiated.</p>
  @[Protocol::Field(location: :uri, name: "Key", required: true)]
  property key : String
  # <p>Upload ID that identifies the multipart upload.</p>
  @[Protocol::Field(location: :query, name: "uploadId", required: true)]
  property upload_id : String
  # 
  @[Protocol::Field(location: :header, name: "x-amz-request-payer", required: false)]
  property request_payer : String?
  # <p>The account id of the expected bucket owner. If the bucket is owned by a different account, the request will fail with an HTTP <code>403 (Access Denied)</code> error.</p>
  @[Protocol::Field(location: :header, name: "x-amz-expected-bucket-owner", required: false)]
  ...
  # 
  @[Protocol::Field(location: :header, name: "x-amz-request-charged", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "ETag", required: false)]
  property e_tag : String?
  # <p>Part number that identifies the part. This is a positive integer between 1 and
  # 10,000.</p>
  @[Protocol::Field(location: :body, name: "PartNumber", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Part", required: false)]
  ...
  # <p>When using this API with an access point, you must direct requests to the access point hostname. The access point hostname takes the form <i>AccessPointName</i>-<i>AccountId</i>.s3-accesspoint.<i>Region</i>.amazonaws.com. When using this operation with an access point through the AWS SDKs, you provide the access point ARN in place of the bucket name. For more information about access point ARNs, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/using-access-points.html">Using Access Points</a> in the <i>Amazon Simple Storage Service Developer Guide</i>.</p>
  # <p>When using this API with Amazon S3 on Outposts, you must direct requests to the S3 on Outposts hostname. The S3 on Outposts hostname takes the form <i>AccessPointName</i>-<i>AccountId</i>.<i>outpostID</i>.s3-outposts.<i>Region</i>.amazonaws.com. When using this operation using S3 on Outposts through the AWS SDKs, you provide the Outposts bucket ARN in place of the bucket name. For more information about S3 on Outposts ARNs, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/S3onOutposts.html">Using S3 on Outposts</a> in the <i>Amazon Simple Storage Service Developer Guide</i>.</p>
  @[Protocol::Field(location: :body, name: "Bucket", required: false)]
  property bucket : String?
  ...
  @[Protocol::Field(location: :header, name: "x-amz-expiration", required: false)]
  ...
  # object.</p>
  @[Protocol::Field(location: :header, name: "x-amz-server-side-encryption", required: false)]
  property server_side_encryption : String?
  # <p>Version ID of the newly created object, in case the bucket has versioning turned
  # on.</p>
  @[Protocol::Field(location: :header, name: "x-amz-version-id", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-server-side-encryption-aws-kms-key-id", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-server-side-encryption-bucket-key-enabled", required: false)]
  ...
  # <p>This action is not supported by Amazon S3 on Outposts.</p>
  @[Protocol::Field(location: :header, name: "x-amz-acl", required: false)]
  property acl : String?
  ...
  @[Protocol::Field(location: :header, name: "Cache-Control", required: false)]
  property cache_control : String?
  # <p>Specifies presentational information for the object.</p>
  @[Protocol::Field(location: :header, name: "Content-Disposition", required: false)]
  property content_disposition : String?
  # <p>Specifies what content encodings have been applied to the object and thus what decoding
  # mechanisms must be applied to obtain the media-type referenced by the Content-Type header
  # field.</p>
  @[Protocol::Field(location: :header, name: "Content-Encoding", required: false)]
  property content_encoding : String?
  # <p>The language the content is in.</p>
  @[Protocol::Field(location: :header, name: "Content-Language", required: false)]
  ...
  # object.</p>
  @[Protocol::Field(location: :header, name: "x-amz-copy-source", required: true)]
  property copy_source : String
  # <p>Copies the object if its entity tag (ETag) matches the specified tag.</p>
  @[Protocol::Field(location: :header, name: "x-amz-copy-source-if-match", required: false)]
  property copy_source_if_match : String?
  # <p>Copies the object if it has been modified since the specified time.</p>
  @[Protocol::Field(location: :header, name: "x-amz-copy-source-if-modified-since", required: false)]
  property copy_source_if_modified_since : Time?
  # <p>Copies the object if its entity tag (ETag) is different than the specified ETag.</p>
  @[Protocol::Field(location: :header, name: "x-amz-copy-source-if-none-match", required: false)]
  property copy_source_if_none_match : String?
  # <p>Copies the object if it hasn't been modified since the specified time.</p>
  @[Protocol::Field(location: :header, name: "x-amz-copy-source-if-unmodified-since", required: false)]
  property copy_source_if_unmodified_since : Time?
  # <p>The date and time at which the object is no longer cacheable.</p>
  @[Protocol::Field(location: :header, name: "Expires", required: false)]
  property expires : Time?
  # <p>Gives the grantee READ, READ_ACP, and WRITE_ACP permissions on the
  # object.</p>
  # <p>This action is not supported by Amazon S3 on Outposts.</p>
  @[Protocol::Field(location: :header, name: "x-amz-grant-full-control", required: false)]
  property grant_full_control : String?
  # <p>Allows grantee to read the object data and its
  # metadata.</p>
  # <p>This action is not supported by Amazon S3 on Outposts.</p>
  @[Protocol::Field(location: :header, name: "x-amz-grant-read", required: false)]
  property grant_read : String?
  # <p>Allows grantee to read the object ACL.</p>
  # <p>This action is not supported by Amazon S3 on Outposts.</p>
  @[Protocol::Field(location: :header, name: "x-amz-grant-read-acp", required: false)]
  property grant_read_acp : String?
  # <p>Allows grantee to write the ACL for the applicable
  # object.</p>
  # <p>This action is not supported by Amazon S3 on Outposts.</p>
  @[Protocol::Field(location: :header, name: "x-amz-grant-write-acp", required: false)]
  property grant_write_acp : String?
  # <p>The key of the destination object.</p>
  @[Protocol::Field(location: :uri, name: "Key", required: true)]
  property key : String
  # <p>A map of metadata to store with the object in S3.</p>
  @[Protocol::Field(location: :header_prefix, name: "x-amz-meta-", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-metadata-directive", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-tagging-directive", required: false)]
  ...
  # the OUTPOSTS Storage Class. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/storage-class-intro.html">Storage Classes</a> in the <i>Amazon S3
  # Service Developer Guide</i>.</p>
  @[Protocol::Field(location: :header, name: "x-amz-storage-class", required: false)]
  property storage_class : String?
  # <p>If the bucket is configured as a website, redirects requests for this object to another
  # object in the same bucket or to an external URL. Amazon S3 stores the value of this header in
  # the object metadata.</p>
  @[Protocol::Field(location: :header, name: "x-amz-website-redirect-location", required: false)]
  property website_redirect_location : String?
  # <p>Specifies the algorithm to use to when encrypting the object (for example,
  # AES256).</p>
  @[Protocol::Field(location: :header, name: "x-amz-server-side-encryption-customer-algorithm", required: false)]
  property sse_customer_algorithm : String?
  # <p>Specifies the customer-provided encryption key for Amazon S3 to use in encrypting data. This
  # value is used to store the object and then it is discarded; Amazon S3 does not store the
  # encryption key. The key must be appropriate for use with the algorithm specified in the
  # <code>x-amz-server-side-encryption-customer-algorithm</code> header.</p>
  @[Protocol::Field(location: :header, name: "x-amz-server-side-encryption-customer-key", required: false)]
  property sse_customer_key : String?
  # <p>Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses
  # this header for a message integrity check to ensure that the encryption key was transmitted
  # without error.</p>
  @[Protocol::Field(location: :header, name: "x-amz-server-side-encryption-customer-key-MD5", required: false)]
  ...
  # pairs.</p>
  @[Protocol::Field(location: :header, name: "x-amz-server-side-encryption-context", required: false)]
  ...
  # AES256).</p>
  @[Protocol::Field(location: :header, name: "x-amz-copy-source-server-side-encryption-customer-algorithm", required: false)]
  property copy_source_sse_customer_algorithm : String?
  # <p>Specifies the customer-provided encryption key for Amazon S3 to use to decrypt the source
  # object. The encryption key provided in this header must be one that was used when the
  # source object was created.</p>
  @[Protocol::Field(location: :header, name: "x-amz-copy-source-server-side-encryption-customer-key", required: false)]
  property copy_source_sse_customer_key : String?
  # <p>Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses
  # this header for a message integrity check to ensure that the encryption key was transmitted
  # without error.</p>
  @[Protocol::Field(location: :header, name: "x-amz-copy-source-server-side-encryption-customer-key-MD5", required: false)]
  ...
  # parameters.</p>
  @[Protocol::Field(location: :header, name: "x-amz-tagging", required: false)]
  property tagging : String?
  # <p>The Object Lock mode that you want to apply to the copied object.</p>
  @[Protocol::Field(location: :header, name: "x-amz-object-lock-mode", required: false)]
  property object_lock_mode : String?
  # <p>The date and time when you want the copied object's Object Lock to expire.</p>
  @[Protocol::Field(location: :header, name: "x-amz-object-lock-retain-until-date", required: false)]
  property object_lock_retain_until_date : Time?
  # <p>Specifies whether you want to apply a Legal Hold to the copied object.</p>
  @[Protocol::Field(location: :header, name: "x-amz-object-lock-legal-hold", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-source-expected-bucket-owner", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "LastModified", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-copy-source-version-id", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "LocationConstraint", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-grant-write", required: false)]
  property grant_write : String?
  # <p>Allows grantee to write the ACL for the applicable bucket.</p>
  @[Protocol::Field(location: :header, name: "x-amz-grant-write-acp", required: false)]
  property grant_write_acp : String?
  # <p>Specifies whether you want S3 Object Lock to be enabled for the new bucket.</p>
  @[Protocol::Field(location: :header, name: "x-amz-bucket-object-lock-enabled", required: false)]
  ...
  # location.</p>
  @[Protocol::Field(location: :header, name: "Location", required: false)]
  property location : String?
end
  ...
  @[Protocol::Field(location: :header, name: "x-amz-abort-date", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-abort-rule-id", required: false)]
  ...
  property key : String?
  # <p>ID for the initiated multipart upload.</p>
  @[Protocol::Field(location: :body, name: "UploadId", required: false)]
  property upload_id : String?
  # <p>The server-side encryption algorithm used when storing this object in Amazon S3 (for example,
  # AES256, aws:kms).</p>
  @[Protocol::Field(location: :header, name: "x-amz-server-side-encryption", required: false)]
  ...
  @[Protocol::Field(location: :query, name: "id", required: true)]
  property id : String
  # <p>The account id of the expected bucket owner. If the bucket is owned by a different account, the request will fail with an HTTP <code>403 (Access Denied)</code> error.</p>
  @[Protocol::Field(location: :header, name: "x-amz-expected-bucket-owner", required: false)]
  property expected_bucket_owner : String?
  ...
  @[Protocol::Field(location: :header, name: "x-amz-mfa", required: false)]
  property mfa : String?
  # <p>VersionId used to reference a specific version of the object.</p>
  @[Protocol::Field(location: :query, name: "versionId", required: false)]
  property version_id : String?
  # 
  @[Protocol::Field(location: :header, name: "x-amz-request-payer", required: false)]
  property request_payer : String?
  ...
  # this operation.</p>
  @[Protocol::Field(location: :header, name: "x-amz-bypass-governance-retention", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-delete-marker", required: false)]
  ...
  # <p>Key name of the object to delete.</p>
  @[Protocol::Field(location: :body, name: "Key", required: true)]
  property key : String
  # <p>VersionId for the specific version of the object to delete.</p>
  @[Protocol::Field(location: :body, name: "VersionId", required: false)]
  property version_id : String?
end
  ...
  @[Protocol::Field(location: :body, name: "Object", required: true)]
  ...
  # its value to true.</p>
  @[Protocol::Field(location: :body, name: "Quiet", required: false)]
  property quiet : Bool?
end
  ...
  @[Protocol::Field(location: :body, name: "DeleteMarker", required: false)]
  property delete_marker : Bool?
  ...
  @[Protocol::Field(location: :body, name: "DeleteMarkerVersionId", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Deleted", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Error", required: false)]
  ...
  # <p>For a list of all the Amazon S3 supported Regions and endpoints, see <a href="https://docs.aws.amazon.com/general/latest/gr/rande.html#s3_region">Regions and Endpoints</a> in the AWS General Reference.</p>
  # </note>
  @[Protocol::Field(location: :body, name: "EmailAddress", required: false)]
  property email_address : String?
  # <p>The canonical user ID of the grantee.</p>
  @[Protocol::Field(location: :body, name: "ID", required: false)]
  property id : String?
  # <p>URI of the grantee group.</p>
  @[Protocol::Field(location: :body, name: "URI", required: false)]
  property uri : String?
  # <p>Type of grantee</p>
  @[Protocol::Field(location: :body, name: "xsi:type", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "Grantee", required: false)]
  property grantee : GranteeStruct?
  # <p>Specifies the permission given to the grantee.</p>
  @[Protocol::Field(location: :body, name: "Permission", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Owner", required: false)]
  property owner : OwnerStruct?
  # <p>A list of grants.</p>
  @[Protocol::Field(location: :body, name: "AccessControlList", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Value", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "Prefix", required: false)]
  property prefix : String?
  # <p>The list of tags to use when evaluating an AND predicate.</p>
  @[Protocol::Field(location: :body, name: "Tag", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Format", required: true)]
  ...
  # </note>
  @[Protocol::Field(location: :body, name: "BucketAccountId", required: false)]
  property bucket_account_id : String?
  # <p>The Amazon Resource Name (ARN) of the bucket to which data is exported.</p>
  @[Protocol::Field(location: :body, name: "Bucket", required: true)]
  property bucket : String
  ...
  @[Protocol::Field(location: :body, name: "S3BucketDestination", required: true)]
  ...
  # <code>V_1</code>.</p>
  @[Protocol::Field(location: :body, name: "OutputSchemaVersion", required: true)]
  property output_schema_version : String
  # <p>The place to store the data for an analysis.</p>
  @[Protocol::Field(location: :body, name: "Destination", required: true)]
  ...
  # exported.</p>
  @[Protocol::Field(location: :body, name: "DataExport", required: false)]
  ...
  # <p>The ID that identifies the analytics configuration.</p>
  @[Protocol::Field(location: :body, name: "Id", required: true)]
  property id : String
  ...
  @[Protocol::Field(location: :body, name: "Filter", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "StorageClassAnalysis", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "AllowedHeader", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "AllowedMethod", required: true)]
  property allowed_methods : Array(String)
  # <p>One or more origins you want customers to be able to access the bucket from.</p>
  @[Protocol::Field(location: :body, name: "AllowedOrigin", required: true)]
  ...
  # object).</p>
  @[Protocol::Field(location: :body, name: "ExposeHeader", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "MaxAgeSeconds", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "CORSRule", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "SSEAlgorithm", required: true)]
  ...
  # Guide</i>.</p>
  # </important>
  @[Protocol::Field(location: :body, name: "KMSMasterKeyID", required: false)]
  ...
  # be applied.</p>
  @[Protocol::Field(location: :body, name: "ApplyServerSideEncryptionByDefault", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "BucketKeyEnabled", required: false)]
  property bucket_key_enabled : Bool?
end
  ...
  # rule.</p>
  @[Protocol::Field(location: :body, name: "Rule", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "And", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Days", required: true)]
  property days : Int32
  ...
  @[Protocol::Field(location: :body, name: "AccessTier", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "Status", required: true)]
  property status : String
  # <p>Specifies the S3 Intelligent-Tiering storage class tier of the configuration.</p>
  @[Protocol::Field(location: :body, name: "Tiering", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "KeyId", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "SSE-S3", required: false)]
  property sses3 : SSES3Struct?
  # <p>Specifies the use of SSE-KMS to encrypt delivered inventory reports.</p>
  @[Protocol::Field(location: :body, name: "SSE-KMS", required: false)]
  ...
  # prevent problems if the destination bucket ownership changes. </p>
  # </note>
  @[Protocol::Field(location: :body, name: "AccountId", required: false)]
  ...
  # results.</p>
  @[Protocol::Field(location: :body, name: "Encryption", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Prefix", required: true)]
  property prefix : String
end
  ...
  @[Protocol::Field(location: :body, name: "Frequency", required: true)]
  ...
  # generated.</p>
  @[Protocol::Field(location: :body, name: "IsEnabled", required: true)]
  ...
  # fields.</p>
  @[Protocol::Field(location: :body, name: "IncludedObjectVersions", required: true)]
  property included_object_versions : String
  # <p>Contains the optional fields that are included in the inventory results.</p>
  @[Protocol::Field(location: :body, name: "OptionalFields", required: false)]
  property optional_fields : Array(String)?
  # <p>Specifies the schedule for generating inventory results.</p>
  @[Protocol::Field(location: :body, name: "Schedule", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "Days", required: false)]
  property days : Int32?
  # <p>Indicates whether Amazon S3 will remove a delete marker with no noncurrent versions. If set
  # to true, the delete marker will be expired; if set to false the policy takes no action.
  # This cannot be specified with Days or Date in a Lifecycle Expiration Policy.</p>
  @[Protocol::Field(location: :body, name: "ExpiredObjectDeleteMarker", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "StorageClass", required: false)]
  property storage_class : String?
end
  ...
  # <i>Amazon Simple Storage Service Developer Guide</i>.</p>
  @[Protocol::Field(location: :body, name: "NoncurrentDays", required: false)]
  ...
  # upload.</p>
  @[Protocol::Field(location: :body, name: "DaysAfterInitiation", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Expiration", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Transition", required: false)]
  ...
  # lifetime. </p>
  @[Protocol::Field(location: :body, name: "NoncurrentVersionTransition", required: false)]
  property noncurrent_version_transitions : Array(NoncurrentVersionTransitionStruct)?
  # 
  @[Protocol::Field(location: :body, name: "NoncurrentVersionExpiration", required: false)]
  property noncurrent_version_expiration : NoncurrentVersionExpirationStruct?
  # 
  @[Protocol::Field(location: :body, name: "AbortIncompleteMultipartUpload", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Rule", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "TargetBucket", required: true)]
  property target_bucket : String
  # <p>Container for granting information.</p>
  @[Protocol::Field(location: :body, name: "TargetGrants", required: false)]
  ...
  # bucket.</p>
  @[Protocol::Field(location: :body, name: "TargetPrefix", required: true)]
  ...
  # 
  @[Protocol::Field(location: :body, name: "LoggingEnabled", required: false)]
  ...
  # 
  @[Protocol::Field(location: :body, name: "FilterRule", required: false)]
  ...
  # 
  @[Protocol::Field(location: :body, name: "S3Key", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Topic", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "Event", required: true)]
  ...
  # when it detects events of the specified type.</p>
  @[Protocol::Field(location: :body, name: "Queue", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "CloudFunction", required: true)]
  ...
  # generated.</p>
  @[Protocol::Field(location: :body, name: "TopicConfiguration", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "QueueConfiguration", required: false)]
  ...
  # them.</p>
  @[Protocol::Field(location: :body, name: "CloudFunctionConfiguration", required: false)]
  ...
  # 
  @[Protocol::Field(location: :body, name: "ObjectOwnership", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "Policy", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "IsPublic", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "SseKmsEncryptedObjects", required: false)]
  ...
  # </note>
  @[Protocol::Field(location: :body, name: "ReplicaModifications", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Owner", required: true)]
  ...
  # Asymmetric Keys</a> in the <i>AWS Key Management Service Developer
  # Guide</i>.</p>
  @[Protocol::Field(location: :body, name: "ReplicaKmsKeyID", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Minutes", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Time", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "EventThreshold", required: false)]
  ...
  # Service Developer Guide</i>.</p>
  @[Protocol::Field(location: :body, name: "Account", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "AccessControlTranslation", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "EncryptionConfiguration", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "ReplicationTime", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Metrics", required: false)]
  ...
  # <i>Amazon Simple Storage Service Developer Guide</i>.</p>
  @[Protocol::Field(location: :body, name: "Priority", required: false)]
  ...
  # Service (SSE-KMS).</p>
  @[Protocol::Field(location: :body, name: "SourceSelectionCriteria", required: false)]
  property source_selection_criteria : SourceSelectionCriteriaStruct?
  # <p></p>
  @[Protocol::Field(location: :body, name: "ExistingObjectReplication", required: false)]
  ...
  # 
  @[Protocol::Field(location: :body, name: "DeleteMarkerReplication", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Role", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "Payer", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "TagSet", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "MfaDelete", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "HostName", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "Suffix", required: true)]
  ...
  # applied.</p>
  @[Protocol::Field(location: :body, name: "HttpErrorCodeReturnedEquals", required: false)]
  ...
  # be applied.</p>
  @[Protocol::Field(location: :body, name: "KeyPrefixEquals", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "HostName", required: false)]
  property host_name : String?
  # <p>The HTTP redirect code to use on the response. Not required if one of the siblings is
  # present.</p>
  @[Protocol::Field(location: :body, name: "HttpRedirectCode", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "ReplaceKeyPrefixWith", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "ReplaceKeyWith", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Condition", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Redirect", required: true)]
  ...
  # bucket.</p>
  @[Protocol::Field(location: :body, name: "RedirectAllRequestsTo", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "IndexDocument", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "ErrorDocument", required: false)]
  property error_document : ErrorDocumentStruct?
  # <p>Rules that define when a redirect is applied and the redirect behavior.</p>
  @[Protocol::Field(location: :body, name: "RoutingRules", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "If-Match", required: false)]
  property if_match : String?
  # <p>Return the object only if it has been modified since the specified time, otherwise
  # return a 304 (not modified).</p>
  @[Protocol::Field(location: :header, name: "If-Modified-Since", required: false)]
  property if_modified_since : Time?
  # <p>Return the object only if its entity tag (ETag) is different from the one specified,
  # otherwise return a 304 (not modified).</p>
  @[Protocol::Field(location: :header, name: "If-None-Match", required: false)]
  property if_none_match : String?
  # <p>Return the object only if it has not been modified since the specified time, otherwise
  # return a 412 (precondition failed).</p>
  @[Protocol::Field(location: :header, name: "If-Unmodified-Since", required: false)]
  ...
  # request.</p>
  # </note>
  @[Protocol::Field(location: :header, name: "Range", required: false)]
  property range : String?
  # <p>Sets the <code>Cache-Control</code> header of the response.</p>
  @[Protocol::Field(location: :query, name: "response-cache-control", required: false)]
  property response_cache_control : String?
  # <p>Sets the <code>Content-Disposition</code> header of the response</p>
  @[Protocol::Field(location: :query, name: "response-content-disposition", required: false)]
  property response_content_disposition : String?
  # <p>Sets the <code>Content-Encoding</code> header of the response.</p>
  @[Protocol::Field(location: :query, name: "response-content-encoding", required: false)]
  property response_content_encoding : String?
  # <p>Sets the <code>Content-Language</code> header of the response.</p>
  @[Protocol::Field(location: :query, name: "response-content-language", required: false)]
  property response_content_language : String?
  # <p>Sets the <code>Content-Type</code> header of the response.</p>
  @[Protocol::Field(location: :query, name: "response-content-type", required: false)]
  property response_content_type : String?
  # <p>Sets the <code>Expires</code> header of the response.</p>
  @[Protocol::Field(location: :query, name: "response-expires", required: false)]
  ...
  @[Protocol::Field(location: :query, name: "partNumber", required: false)]
  property part_number : Int32?
  # <p>The account id of the expected bucket owner. If the bucket is owned by a different account, the request will fail with an HTTP <code>403 (Access Denied)</code> error.</p>
  @[Protocol::Field(location: :header, name: "x-amz-expected-bucket-owner", required: false)]
  property expected_bucket_owner : String?
  ...
  @[Protocol::Field(location: :header, name: "accept-ranges", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-restore", required: false)]
  property restore : String?
  # <p>Last modified date of the object</p>
  @[Protocol::Field(location: :header, name: "Last-Modified", required: false)]
  property last_modified : Time?
  # <p>Size of the body in bytes.</p>
  @[Protocol::Field(location: :header, name: "Content-Length", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "ETag", required: false)]
  property e_tag : String?
  ...
  @[Protocol::Field(location: :header, name: "x-amz-missing-meta", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "Content-Range", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-replication-status", required: false)]
  property replication_status : String?
  # <p>The count of parts this object has.</p>
  @[Protocol::Field(location: :header, name: "x-amz-mp-parts-count", required: false)]
  property parts_count : Int32?
  # <p>The number of tags, if any, on the object.</p>
  @[Protocol::Field(location: :header, name: "x-amz-tagging-count", required: false)]
  ...
  property storage_class : String?
  # 
  @[Protocol::Field(location: :body, name: "AccessTier", required: false)]
  property access_tier : String?
end
  ...
  # specified bucket.</p>
  @[Protocol::Field(location: :body, name: "Mode", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Years", required: false)]
  ...
  # specified bucket.</p>
  @[Protocol::Field(location: :body, name: "DefaultRetention", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "ObjectLockEnabled", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "RetainUntilDate", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "BlockPublicAcls", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "IgnorePublicAcls", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "BlockPublicPolicy", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "RestrictPublicBuckets", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-archive-status", required: false)]
  ...
  # begin.</p>
  @[Protocol::Field(location: :query, name: "continuation-token", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "IsTruncated", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "ContinuationToken", required: false)]
  property continuation_token : String?
  # <p>
  ...
  # usable value.</p>
  @[Protocol::Field(location: :body, name: "NextContinuationToken", required: false)]
  property next_continuation_token : String?
  # <p>The list of analytics configurations for a bucket.</p>
  @[Protocol::Field(location: :body, name: "AnalyticsConfiguration", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "IntelligentTieringConfiguration", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "InventoryConfiguration", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "MetricsConfiguration", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "CreationDate", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Buckets", required: false)]
  ...
  # response.</p>
  @[Protocol::Field(location: :query, name: "delimiter", required: false)]
  property delimiter : String?
  # 
  @[Protocol::Field(location: :query, name: "encoding-type", required: false)]
  ...
  @[Protocol::Field(location: :query, name: "key-marker", required: false)]
  ...
  @[Protocol::Field(location: :query, name: "max-uploads", required: false)]
  ...
  @[Protocol::Field(location: :query, name: "prefix", required: false)]
  property prefix : String?
  ...
  # <code>upload-id-marker</code>.</p>
  @[Protocol::Field(location: :query, name: "upload-id-marker", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Initiated", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Initiator", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "KeyMarker", required: false)]
  property key_marker : String?
  # <p>Upload ID after which listing began.</p>
  @[Protocol::Field(location: :body, name: "UploadIdMarker", required: false)]
  property upload_id_marker : String?
  ...
  @[Protocol::Field(location: :body, name: "NextKeyMarker", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Delimiter", required: false)]
  property delimiter : String?
  # <p>When a list is truncated, this element specifies the value that should be used for the
  # <code>upload-id-marker</code> request parameter in a subsequent request.</p>
  @[Protocol::Field(location: :body, name: "NextUploadIdMarker", required: false)]
  property next_upload_id_marker : String?
  # <p>Maximum number of multipart uploads that could have been included in the
  # response.</p>
  @[Protocol::Field(location: :body, name: "MaxUploads", required: false)]
  property max_uploads : Int32?
  ...
  @[Protocol::Field(location: :body, name: "Upload", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "CommonPrefixes", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "EncodingType", required: false)]
  property encoding_type : String?
end
  ...
  @[Protocol::Field(location: :query, name: "marker", required: false)]
  ...
  # </p>
  @[Protocol::Field(location: :query, name: "max-keys", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Marker", required: false)]
  property marker : String?
  ...
  @[Protocol::Field(location: :body, name: "NextMarker", required: false)]
  property next_marker : String?
  # <p>Metadata about each object returned.</p>
  @[Protocol::Field(location: :body, name: "Contents", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "MaxKeys", required: false)]
  property max_keys : Int32?
  ...
  @[Protocol::Field(location: :query, name: "fetch-owner", required: false)]
  property fetch_owner : Bool?
  # <p>StartAfter is where you want Amazon S3 to start listing from. Amazon S3 starts listing after this
  # specified key. StartAfter can be any key in the bucket.</p>
  @[Protocol::Field(location: :query, name: "start-after", required: false)]
  ...
  # equals 50 keys </p>
  @[Protocol::Field(location: :body, name: "KeyCount", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "StartAfter", required: false)]
  property start_after : String?
end
  ...
  @[Protocol::Field(location: :query, name: "version-id-marker", required: false)]
  ...
  # object.</p>
  @[Protocol::Field(location: :body, name: "IsLatest", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "VersionIdMarker", required: false)]
  property version_id_marker : String?
  ...
  @[Protocol::Field(location: :body, name: "NextVersionIdMarker", required: false)]
  ...
  @[Protocol::Field(location: :query, name: "max-parts", required: false)]
  property max_parts : Int32?
  # <p>Specifies the part after which listing should begin. Only parts with higher part numbers
  # will be listed.</p>
  @[Protocol::Field(location: :query, name: "part-number-marker", required: false)]
  ...
  # request.</p>
  @[Protocol::Field(location: :body, name: "PartNumberMarker", required: false)]
  property part_number_marker : String?
  # <p>When a list is truncated, this element specifies the last part in the list, as well as
  # the value to use for the part-number-marker request parameter in a subsequent
  # request.</p>
  @[Protocol::Field(location: :body, name: "NextPartNumberMarker", required: false)]
  property next_part_number_marker : String?
  # <p>Maximum number of parts that were allowed in the response.</p>
  @[Protocol::Field(location: :body, name: "MaxParts", required: false)]
  property max_parts : Int32?
  ...
  @[Protocol::Field(location: :header, name: "Content-MD5", required: false)]
  ...
  # <p>A set of origins and methods (cross-origin access that you want to allow). You can add
  # up to 100 rules to the configuration.</p>
  @[Protocol::Field(location: :body, name: "CORSRule", required: true)]
  property cors_rules : Array(CORSRuleStruct)
end
  ...
  @[Protocol::Field(location: :header, name: "x-amz-confirm-remove-self-bucket-access", required: false)]
  ...
  @[Protocol::Field(location: :header, name: "x-amz-bucket-object-lock-token", required: false)]
  ...
  # <p>Specifies who pays for the download and request fees.</p>
  @[Protocol::Field(location: :body, name: "Payer", required: true)]
  property payer : String
end
  ...
  @[Protocol::Field(location: :body, name: "Tier", required: true)]
  ...
  # </li>
  # </ul>
  @[Protocol::Field(location: :body, name: "FileHeaderInfo", required: false)]
  ...
  # line.</p>
  @[Protocol::Field(location: :body, name: "Comments", required: false)]
  property comments : String?
  # <p>A single character used for escaping the quotation mark character inside an already
  # escaped value. For example, the value """ a , b """ is parsed as " a , b ".</p>
  @[Protocol::Field(location: :body, name: "QuoteEscapeCharacter", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "RecordDelimiter", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "FieldDelimiter", required: false)]
  ...
  # </p>
  @[Protocol::Field(location: :body, name: "QuoteCharacter", required: false)]
  property quote_character : String?
  # <p>Specifies that CSV field values may contain quoted record delimiters and such records
  # should be allowed. Default value is FALSE. Setting this value to TRUE may lower
  # performance.</p>
  @[Protocol::Field(location: :body, name: "AllowQuotedRecordDelimiter", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "CSV", required: false)]
  property csv : CSVInputStruct?
  # <p>Specifies object's compression format. Valid values: NONE, GZIP, BZIP2. Default Value:
  # NONE.</p>
  @[Protocol::Field(location: :body, name: "CompressionType", required: false)]
  property compression_type : String?
  # <p>Specifies JSON as object's input serialization format.</p>
  @[Protocol::Field(location: :body, name: "JSON", required: false)]
  property json : JSONInputStruct?
  # <p>Specifies Parquet as object's input serialization format.</p>
  @[Protocol::Field(location: :body, name: "Parquet", required: false)]
  ...
  # </li>
  # </ul>
  @[Protocol::Field(location: :body, name: "QuoteFields", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "InputSerialization", required: true)]
  property input_serialization : InputSerializationStruct
  # <p>The type of the provided expression (for example, SQL).</p>
  @[Protocol::Field(location: :body, name: "ExpressionType", required: true)]
  property expression_type : String
  # <p>The expression that is used to query the object.</p>
  @[Protocol::Field(location: :body, name: "Expression", required: true)]
  property expression : String
  # <p>Describes how the results of the Select job are serialized.</p>
  @[Protocol::Field(location: :body, name: "OutputSerialization", required: true)]
  ...
  # AES256, aws:kms).</p>
  @[Protocol::Field(location: :body, name: "EncryptionType", required: true)]
  ...
  # Asymmetric Keys</a> in the <i>AWS Key Management Service Developer
  # Guide</i>.</p>
  @[Protocol::Field(location: :body, name: "KMSKeyId", required: false)]
  property kms_key_id : String?
  # <p>If the encryption type is <code>aws:kms</code>, this optional value can be used to
  # specify the encryption context for the restore results.</p>
  @[Protocol::Field(location: :body, name: "KMSContext", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "BucketName", required: true)]
  ...
  @[Protocol::Field(location: :body, name: "CannedACL", required: false)]
  property canned_acl : String?
  # <p>A list of grants that control access to the staged results.</p>
  @[Protocol::Field(location: :body, name: "AccessControlList", required: false)]
  property access_control_list : Array(GrantStruct)?
  # <p>The tag-set that is applied to the restore results.</p>
  @[Protocol::Field(location: :body, name: "Tagging", required: false)]
  property tagging : TaggingStruct?
  # <p>A list of metadata to store with the restore results in S3.</p>
  @[Protocol::Field(location: :body, name: "UserMetadata", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "S3", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "GlacierJobParameters", required: false)]
  property glacier_job_parameters : GlacierJobParametersStruct?
  # <p>Type of restore request.</p>
  @[Protocol::Field(location: :body, name: "Type", required: false)]
  property type : String?
  # <p>Retrieval tier at which the restore will be processed.</p>
  @[Protocol::Field(location: :body, name: "Tier", required: false)]
  property tier : String?
  # <p>The optional description for the job.</p>
  @[Protocol::Field(location: :body, name: "Description", required: false)]
  property description : String?
  # <p>Describes the parameters for Select job types.</p>
  @[Protocol::Field(location: :body, name: "SelectParameters", required: false)]
  property select_parameters : SelectParametersStruct?
  # <p>Describes the location where the restore job's output is stored.</p>
  @[Protocol::Field(location: :body, name: "OutputLocation", required: false)]
  ...
  # restored to.</p>
  @[Protocol::Field(location: :header, name: "x-amz-restore-output-path", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Enabled", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Start", required: false)]
  ...
  # last 50 bytes.</p>
  @[Protocol::Field(location: :body, name: "End", required: false)]
  property end : Int64?
end
  ...
  @[Protocol::Field(location: :body, name: "RequestProgress", required: false)]
  ...
  # </li>
  # </ul>
  @[Protocol::Field(location: :body, name: "ScanRange", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Payload", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "BytesScanned", required: false)]
  property bytes_scanned : Int64?
  # <p>The total number of uncompressed object bytes processed.</p>
  @[Protocol::Field(location: :body, name: "BytesProcessed", required: false)]
  property bytes_processed : Int64?
  # <p>The total number of bytes of records payload data returned.</p>
  @[Protocol::Field(location: :body, name: "BytesReturned", required: false)]
  ...
  @[Protocol::Field(location: :body, name: "Details", required: false)]
  ...
  # 10,000.</p>
  @[Protocol::Field(location: :query, name: "partNumber", required: true)]
  property part_number : Int32
  ...
  @[Protocol::Field(location: :header, name: "x-amz-copy-source-range", required: false)]
